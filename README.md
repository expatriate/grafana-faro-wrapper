...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `checkRender(selectors)`<br><picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-render-pass-dark.gif"><img src=".github/assets/render-helpers/check-render-pass-light.gif" width="150" height="70" alt="checkRender проходит"></picture> <picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-render-fail-dark.gif"><img src=".github/assets/render-helpers/check-render-fail-light.gif" width="150" height="70" alt="checkRender не проходит"></picture>                                                                                                                                                                                                                  | каждый селектор (строка или массив) есть в DOM                                      |
| `checkRenderInnerValue(selectors)`<br><picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-render-inner-value-pass-dark.gif"><img src=".github/assets/render-helpers/check-render-inner-value-pass-light.gif" width="150" height="70" alt="checkRenderInnerValue проходит"></picture> <picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-render-inner-value-fail-dark.gif"><img src=".github/assets/render-helpers/check-render-inner-value-fail-light.gif" width="150" height="70" alt="checkRenderInnerValue не проходит"></picture>                                                                                                                                    | по каждому селектору есть видимый элемент с текстом (см. ниже)                      |
| `checkEnabledButtonState(selector)`<br><picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-enabled-button-state-pass-dark.gif"><img src=".github/assets/render-helpers/check-enabled-button-state-pass-light.gif" width="150" height="70" alt="checkEnabledButtonState проходит"></picture> <picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-enabled-button-state-fail-dark.gif"><img src=".github/assets/render-helpers/check-enabled-button-state-fail-light.gif" width="150" height="70" alt="checkEnabledButtonState не проходит"></picture>                                                                                                                       | есть видимая кнопка, которую можно нажать (см. ниже)                                |
| `getAmount(selector)`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | возвращает число элементов                                                          |
| `checkAmount(selector, n)`, `checkGTEAmount(selector, n)`<br><picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-amount-pass-dark.gif"><img src=".github/assets/render-helpers/check-amount-pass-light.gif" width="150" height="70" alt="checkAmount проходит"></picture> <picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/check-amount-fail-dark.gif"><img src=".github/assets/render-helpers/check-amount-fail-light.gif" width="150" height="70" alt="checkAmount не проходит"></picture>                                                                                                                                                                                 | элементов ровно `n` / не меньше `n`                                                 |
| `checkImagesIsDisplayed(selector)`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | синхронно: все картинки уже загружены (битый SVG не отличает, см. ниже)             |
| `asyncCheckImagesIsDisplayed(selector, timeoutMs?)`<br><picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/async-check-images-is-displayed-pass-dark.gif"><img src=".github/assets/render-helpers/async-check-images-is-displayed-pass-light.gif" width="150" height="70" alt="asyncCheckImagesIsDisplayed проходит"></picture> <picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/async-check-images-is-displayed-fail-dark.gif"><img src=".github/assets/render-helpers/async-check-images-is-displayed-fail-light.gif" width="150" height="70" alt="asyncCheckImagesIsDisplayed не проходит"></picture>                                                                           | все картинки загрузились за `timeoutMs`                                             |
| `asyncCheckBackgroundImagesIsDisplayed(selector, timeoutMs?)`<br><picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/async-check-background-images-is-displayed-pass-dark.gif"><img src=".github/assets/render-helpers/async-check-background-images-is-displayed-pass-light.gif" width="150" height="70" alt="asyncCheckBackgroundImagesIsDisplayed проходит"></picture> <picture><source media="(prefers-color-scheme: dark)" srcset=".github/assets/render-helpers/async-check-background-images-is-displayed-fail-dark.gif"><img src=".github/assets/render-helpers/async-check-background-images-is-displayed-fail-light.gif" width="150" height="70" alt="asyncCheckBackgroundImagesIsDisplayed не проходит"></picture> | у каждого элемента загрузилась своя картинка: `<img>` внутри или `background-image` |
| `extractBackgroundUrl(element)`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | URL из `background-image`, у `image-set()` — под плотность экрана, или `null`       |
...
- Селектор может указывать на `<img>` или на обёртку: тогда проверяются картинки внутри, обёртка без них
  (например, только с inline `<svg>`) — `false`. Картинки внутри Shadow DOM хелперы не видят.
- Асинхронные проверки верят браузеру: картинка засчитывается, если загрузилась без ошибки, в том числе SVG без
  собственных размеров. Синхронная проверка видит только то, что уже загружено, и не отличает битый SVG (404,
  HTML-страница вместо картинки, неверный MIME) от загруженного — для SVG берите асинхронную.
...
- Из `background-image` берётся первый `url()`, а у `image-set()` — вариант под плотность экрана, как у
  браузера. Элемент без `<img>` и без `url()` — например, с фоном из одного градиента — даёт `false`; фоны
  `::before`/`::after` не учитываются. Фоны и `loadImage` держат одну картинку на адрес, поэтому повторная
  проверка битого фона внутри `trackSlo` не шлёт новый запрос.
- `checkRenderInnerValue` и `checkEnabledButtonState` проходят, если подходит хотя бы один элемент по
  селектору, — так учитываются и адаптивные дубли блока. Текст должен быть виден: скрытый блок или потомок
  (`display: none`, `hidden`, `visibility: hidden`), стили, скрипты и пробелы не в счёт. Текст, спрятанный
  только визуально (`opacity: 0`, sr-only, за экраном), засчитывается.
- Кнопку можно нажать, если она видна, не `:disabled` (в том числе через `<fieldset disabled>`), не внутри
  `inert`, без `aria-disabled="true"`, класса `disabled` и `pointer-events: none`. Перекрытие другим элементом
  (например, спиннером) и `opacity: 0` не проверяются.
- `checkRender`, `getAmount`, `checkAmount` и `checkGTEAmount` учитывают и скрытые элементы. Пустой список
  селекторов не проходит; число элементов можно передать строкой, например из `data-*` атрибута.
