...
| `checkRenderInnerValue(selectors)`                            | по каждому селектору есть видимый элемент с текстом (см. ниже)                      |
| `checkEnabledButtonState(selector)`                           | есть видимая кнопка, которую можно нажать (см. ниже)                                |
...
| `asyncCheckImagesIsDisplayed(selector, timeoutMs?)`           | все картинки загрузились за `timeoutMs`                                             |
